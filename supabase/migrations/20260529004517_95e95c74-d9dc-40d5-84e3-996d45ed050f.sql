-- 1. Fix SECURITY DEFINER view: enforce querying user's permissions
ALTER VIEW public.vw_journey_ranking SET (security_invoker = on);
...
-- 3. Add DELETE policy on applications for admins/super_admins
